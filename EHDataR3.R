...
{  
  ...
  p <- eval(substitute(a1 +
    ...
    geom_text(aes(label = scales::comma(Total)), size=(4), color="blue", hjust = -.2) +
    scale_y_continuous(labels = comma, limits = c(ylimitmin, ylimitmax)), list(i=i)))
  plot_list[[i]] <- p 
